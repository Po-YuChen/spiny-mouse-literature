...
st.markdown(
    ...
    /* Make the search form a positioning container */
    div[data-testid="stForm"] {
        position: relative;
    }

    /* Add space on the left side of the input for the X button */
    div[data-testid="stForm"] .stTextInput input {
        padding-left: 42px !important;
    }

    /* Move the first form button into the input box */
    ...
    /* Hover style */
    div[data-testid="stForm"] div[data-testid="stFormSubmitButton"]:first-of-type button:hover {
        border: none !important;
        background: transparent !important;
        color: #111827 !important;
    }

    /* Remove focus border around the X button */
    div[data-testid="stForm"] div[data-testid="stFormSubmitButton"]:first-of-type button:focus {
        box-shadow: none !important;
...
with st.form(
    ...
    # This button is visually moved inside
    # the left side of the search input by CSS
